...
import 'package:veloute_app/presentation/views/authentication/widgets/social_signin_button.dart';
        ...
        Row(
          ...
          children: [
            Text(
              ...
              style: TextStyle(
                  fontSize: FontsManager.s14.sp, color: ColorsManager.white),
            ),
            5.w.emptyWidth,
            InkWell(
              ...
              child: Text(
                  ...
                  style: TextStyle(
                      fontSize: FontsManager.s14.sp, color: ColorsManager.primary)),
            ),
          ],
        )
      ],
